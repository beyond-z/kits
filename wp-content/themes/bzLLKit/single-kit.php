...
<div id="primary" class="content-area">
	...
	if (!empty($customfields['bz_kit_prework'])){ ?>
		<div class="kit-component prework start-collapsed">
			<h2><?php echo __($customfields['bz_kit_prework_header'][0] ?? 'Fellows\' Prework', 'bz'); ?></h2>
  ...
  <?php
	...
	if (!empty($customfields['bz_kit_after'])){ ?>
		<div class="kit-component important">
			<h2><?php echo __($customfields['bz_kit_after_header'][0] ?? 'Fellows: After Learning Lab', 'bz'); ?></h2>
